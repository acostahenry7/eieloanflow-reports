  ...
  return (
    <div className="dash-container">
      <div className="loan-requests">
        ...
        >
          <div>
            <div className="title">Cobros</div>
            <div className="sub-title">Resumen de cobros</div>
          </div>
          <div>
        ...
        <div className="list">
          ...
          <div className="item">
            <div className="card-header">
              <div className="name">Cobros - cancelados</div>
              <div className="filter">
                <select
                  style={{ marginRight: 10 }}
                  onChange={(e) =>
