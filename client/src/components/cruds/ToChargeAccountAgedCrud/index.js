...
import { generateReport } from "../../../utils/reports/toChargeAccountAged";
import { tableUIHelper } from "../../../utils/ui-helpers";
import "./index.css";

function ToChargeAccountAgedCrud() {
  ...
  React.useEffect(() => {
    (async () => {
      try {
        ...
        const response = await getToChargeAccountAged(searchParams);
...
export { ToChargeAccountAgedCrud };
