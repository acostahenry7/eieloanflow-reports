  ...
  React.useEffect(() => {
    (async () => {
      try {
        ...
        const receipts = await getReceiptDetail(searchParams);
        if (receipts.error == true) {
          throw new Error(receipts.body);
        }
        console.log(receipts.body);
        setOutlets(outlets.body);
        setData(receipts.body);
      } catch (error) {
